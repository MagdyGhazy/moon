        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-5 offset-lg-1 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              ...
              <p class="description">{{$Service->ServicesDiscription}}</p>
            </div>
          </div>
            @endforeach
        </div>
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div>
                  ...
                  <a href="{{$app->AppLink}}" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div>
                  ...
                  <a href="{{$web->WebLinke}}" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  ...
                  <span>{{$team->job}}</span>
                  <div class="social">
                    <a href="{{$team->ig}}"><i class="fa fa-instagram"></i></a>
                    <a href="{{$team->fb}}"><i class="fa fa-facebook"></i></a>
                    <a href="{{$team->gm}}"><i class="fa fa-google-plus"></i></a>
                    <a href="{{$team->li}}"><i class="fa fa-linkedin"></i></a>
                  </div>
                </div>
              </div>
            </div>
