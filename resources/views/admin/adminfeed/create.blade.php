                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('admin.adminfeed.store')}}" method="post">
                                            @csrf
                                            <div class="col-12 mb-2" >
                                                <div class="form-group" >
                                                    <label for="state"><strong>Choose Comment</strong>
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <br>
                                                    <select class="form-control @error('state') is-invalid @enderror" name="commentId" id="state">
                                                        @foreach(\App\Models\UserFeed::all() as $value)
                                                            <option value="{{ $value->id }}" @if((int)old('type') === $value) selected @endif> {{$value->comment}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
...
{{--                                                        <span class="text-danger">*</span>--}}
{{--                                                    </label>--}}
{{--                                                    <input type="text"  name="comment" id="category_id" class="form-control">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-12 mb-2">--}}
