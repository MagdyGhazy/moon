                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header ">
                            ...
                            <div>
                                @can('create-content')
                                <a title="{{__('messages.static.create')}}" id="create-btn" href="{{route('admin.adminfeed.create')}}" class="btn btn-icon btn-outline-primary">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <td style="width: 15%;align-content: center"><img style="width: 40%" @if($user->image == null)
