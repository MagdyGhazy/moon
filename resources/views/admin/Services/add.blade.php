                        ...
                        <div class="card">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="{{route('admin.servces.store')}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12 mb-2" >
                                                    ...
                                                    <div class="form-group" >
                                                        ...
                                                        <input type="text"  name="icon" id="Services" class="form-control">
                                                ...
                                                <div class="col-12 mb-2" >
                                                    <div class="form-group" >
                                                        <label for="section">ServicesDiscription
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                        <textarea name="ServicesDiscription" id="ServicesDiscription" class="form-control"></textarea>
                                                    </div>
                                                </div>
