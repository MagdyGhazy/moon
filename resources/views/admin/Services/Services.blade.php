                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header ">
                                <div>
                                    @can('create-content')
                                        <a title="{{__('messages.static.create')}}"  id="create-btn" href="{{route('admin.servces.create')}}"
                                                ...
                                                <td>
                                                    <div class="row wow fadeInUp" style="justify-content: right ">
                                                        <span style="padding-left: 2% ;width: auto">
                                                               <a class="btn btn-primary" href="{{route('admin.servces.edit', $Service->id)}}" role="button"><i class="mr-50 fas fa-edit"></i></a>
                                                        </span>


                                                        <span>
                                                    <form action="{{route('admin.servces.destroy', $Service->id)}}" method="post">
