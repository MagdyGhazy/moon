                        ...
                        <div class="card">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="{{route('admin.main.store')}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-2" >
                                                    <div class="form-group" >
                                                        ...
                                                        <textarea name="discription" id="category_id" class="form-control"></textarea>
                                                    </div>
                                                </div>
