                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{route('admin.categories.index')}}"> {{__('messages.static.list',['name'=> trans_choice('labels.models.category',2)])}}</a>
                                    </li>
                                                ...
                                                <div class="col-12 mb-2" >
                                                    <div class="form-group" >
                                                        ...
                                                        <select name="parent_id" id="parent" class="form-control"
                                                            {{--required
                                                            oninvalid="this.setCustomValidity('يرجى اختيار الصنف  ');"
                                                            onchange="try{setCustomValidity('')}catch(e){}" --}}
                                                        >
                                                    ...
                                                    <div class="form-group" >
                                                        ...
                                                        <select class="form-control @error('type') is-invalid @enderror" name="type" id="type">
                                                            @foreach(\App\Enums\SectionType::values() as $value)
                                                                <option value="{{$value}}" @if((int)old('type') === $value) selected @endif> {{__('labels.enum.category.type.'.$value)}}</option>
                                                            @endforeach
                                                        </select>
                                                        @error("type")
                                                        <div class="invalid-feedback">{{ $message }}</div>
