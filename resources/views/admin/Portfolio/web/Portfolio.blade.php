                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header ">
                                <div>
                                    @can('create-content')
                                        <a title="{{__('messages.static.create')}}"  id="create-btn" href="{{route('admin.WEB.create')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">WebName</th>
                                            <th scope="col">WebImage</th>
                                            <th scope="col">WebLinke</th>
                                                ...
                                                <td>
                                                    <div class="row wow fadeInUp" style="justify-content: right ">
                                                        <span style="padding-left: 2% ;width: auto">
                                                               <a class="btn btn-primary" href="{{route('admin.WEB.edit', $Portfolio->id)}}" role="button"><i class="mr-50 fas fa-edit"></i></a>
                                                        </span>


                                                        <span>
                                                    <form action="{{route('admin.WEB.destroy', $Portfolio->id)}}" method="post">
